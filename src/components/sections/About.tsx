            ...
            <Reveal delay={0.15}>
              <div className="mt-8 p-6 glass rounded-2xl border-l-2 border-l-cyan">
                <p className="text-sm text-muted-foreground leading-relaxed italic">
                  "Our mission is to accelerate breakthroughs in plasma science by uniting researchers,
                  industry pioneers, and emerging scholars under one roof — bridging fundamental physics with
                  transformative applications across energy, medicine, and space."
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {STATS.map((s, i) => (
              <Reveal key={s.label} delay={i * 0.08}>
                <div className="glass rounded-2xl p-5 h-full hover:border-glow transition-all">
